...
model = dmnet('dmnet_membrane_PS5.hdf5')
...
eps = 0.001
fileList1 = os.listdir('Test/test_PS/pred2/')
fileList2 = os.listdir('Test/test_PS/dmOP/')
...
#        print model.summary()
        ...
        print(img.max())
        imsave("Test/test_PS/OP/" + f1, img.astype('uint8'))
        

testImages(fileList1,'Test/test_PS/pred2/', 'Test/test_PS/dmOP/')
